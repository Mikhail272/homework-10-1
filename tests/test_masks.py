...
def test_get_mask_card_number():
    ...
    assert get_mask_card_number("abcdefghabcdefgh") == "Неверный формат банковской карты"
...
def test_get_mask_card_number_parametrized(x):
    ...
    expected_masked = f"{card_number_str[:4]} {card_number_str[4:6]}** **** {card_number_str[-4:]}"
...
@pytest.mark.parametrize("x", [
    ...
    773654108430135874305,
    3373654108430135874305
])
